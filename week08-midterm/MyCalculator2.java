...
public class MyCalculator2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Result: " + MyCalculator2.evaluate(exp1) + "\n");
        String exp2 = "(5+2)*3-(8/2)";
        System.out.println("Infix Expression: " + exp2);
        String exp2Postfix = MyCalculator2.infix2Postfix(exp2);
        System.out.println("Convert Infix to Postfix: " + exp2Postfix);
        System.out.println("Result: " + MyCalculator2.evaluate(exp2Postfix));
    }
}
